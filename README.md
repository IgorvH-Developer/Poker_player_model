...
Чтобы решить проблему выбора выгодного действия, модель обучается с ранними версиями самой себя, что позволяет построить полное дерево всевозможных действий на каждой стадии.
На каждой раздаче, обходя всё игровое дерево, можно выбрать наиболее выгодное действие, используя минимизацию сожалений. 

Выбранное действие будет меткой для игровой ситуации, в которой это действие совершено. Таким образом имеются как входные данные для модели (игровые ситуации), так и метки к ним (наиболее выгодные действия в данных ситуациях). На этом наборе данных и меток обучается модель.

Примерный вид игрового дерева:
